 ...
 */
public class PanelMnemonicInternalLoad extends javax.swing.JPanel 
        implements UpdateReceiver {

    /**
     * Creates new form PanelMneomonicInternalLoad
     */
    public PanelMnemonicInternalLoad() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(valve1, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 83, -1, -1));
        add(valve2, new org.netbeans.lib.awtextra.AbsoluteConstraints(129, 83, -1, -1));
        add(valve3, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 233, -1, -1));
        add(valve4, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 273, -1, -1));

        valve5.setVertical(true);
        add(valve5, new org.netbeans.lib.awtextra.AbsoluteConstraints(115, 256, -1, -1));

        valve6.setVertical(true);
        add(valve6, new org.netbeans.lib.awtextra.AbsoluteConstraints(63, 256, -1, -1));

        valve7.setVertical(true);
        add(valve7, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 16, -1, -1));

        valve8.setVertical(true);
        add(valve8, new org.netbeans.lib.awtextra.AbsoluteConstraints(183, 16, -1, -1));

        valve9.setVertical(true);
        add(valve9, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 230, -1, -1));

        valve10.setVertical(true);
        add(valve10, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 143, -1, -1));

        valve11.setVertical(true);
        add(valve11, new org.netbeans.lib.awtextra.AbsoluteConstraints(172, 143, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/hartrusion/rbmksim/gui/mnemonic/MnemonicInternalLoad.png"))); // NOI18N
