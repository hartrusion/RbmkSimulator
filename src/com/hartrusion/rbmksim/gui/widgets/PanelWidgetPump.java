...
public class PanelWidgetPump extends AbstractPanelWidget {
    ...
    private void initComponents() {
        ...
        add(jToggleButtonPump, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 86, 20, 20));

        lightBulbReady.setForeground(new java.awt.Color(0, 255, 0));
        add(lightBulbReady, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 77, -1, -1));
    ...
    public void updateComponent(PropertyChangeEvent evt) {
        ...
        switch (component) {
            case "SuctionValve_Pos":
                setValveButtonsLess(jButtonSuctionClose, 
                        jButtonSuctionOpen,evt.getNewValue());
                break;
            case "DischargeValve_Pos":
                setValveButtonsLess(jButtonDischargeClose, 
