...
//            le.addLine(l);
   ...
   public static void drumPressures(FigureJPane figure, ValueHandler plotData) {
    ...
    public static void coreTemperaturesDebugging(FigureJPane figure, ValueHandler plotData) {
        figure.setYRulers(3);
        MYAxes ax = (MYAxes) figure.getLastAxes();
        Legend le = new Legend();
        ax.setHold(true);
        ...
        l = new Line();
        le.addLine(l);
        l.setLabel("Core 1 Temp");
        l.setDataSource(plotData.getTime60(2),
                plotData.getParameterDoubleSeries("Core1#Temperature", 2));
        l.setLineColor(Color.BLUE);
        ax.addLine(1, l);
        
        l = new Line();
        le.addLine(l);
        l.setLabel("Core 2 Temp");
        l.setDataSource(plotData.getTime60(2),
                plotData.getParameterDoubleSeries("Core2#Temperature", 2));
        l.setLineColor(Color.BLUE);
        ax.addLine(1, l);
        
        l = new Line();
        le.addLine(l);
        l.setLabel("Evap 1 Heat");
        l.setDataSource(plotData.getTime60(2),
                plotData.getParameterDoubleSeries("Loop1#EvapSpecHeatEnergy", 2));
        ax.addLine(2, l);
        
        l = new Line();
        le.addLine(l);
        l.setLabel("Evap 2 Heat");
        l.setDataSource(plotData.getTime60(2),
                plotData.getParameterDoubleSeries("Loop2#EvapSpecHeatEnergy", 2));
        ax.addLine(2, l);
        
        l = new Line();
        le.addLine(l);
        l.setLabel("Evap 1 Mass");
        l.setDataSource(plotData.getTime60(2),
                plotData.getParameterDoubleSeries("Loop1#EvapMass", 2));
        ax.addLine(3, l);
        
        l = new Line();
        le.addLine(l);
        l.setLabel("Evap 2 Mass");
        l.setDataSource(plotData.getTime60(2),
                plotData.getParameterDoubleSeries("Loop2#EvapMass", 2));
        ax.addLine(3, l);
        ...
        ax.ylabel("Temperature (°C)");
        ax.ylabel(2, "Evaporator spec. Heat Energy (kJ/kg)");
        ax.ylabel(3, "Evaporator Steam Mass (kg)");
    }
}
